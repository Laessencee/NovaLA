       ...
       <!-- parte alterada,por matheus-->
        ...
        <nav class="navbar">
          <ul class="navbar-list">
            <li>
            <a href="/NovaLA/homepage.html" class="navbar-link has-after">Home</a><!-- Link para a seção Home -->
            </li>
            <li>
              <a href="#produtos" class="navbar-link has-after">Produtos</a> <!-- Link para a seção Produtos -->
            </li>
            <li>
              <a href="#destaques" class="navbar-link has-after">Destaques</a> <!-- Link para a seção Destaques -->
            </li>
          </ul>
        </nav>
  ...
  <div class="sidebar">
    <div class="mobile-navbar" data-navbar>
      ...
      <ul class="navbar-list">
        ...
        <li>
          <a href="#destaques" class="navbar-link" data-nav-link>Destaques</a> <!-- Link para a seção Destaques -->
        </li>
      </ul>
          ...
          <ul class="collection-list">
            ...
            <li>
              <div class="collection-card has-before hover:shine">
                <h2 class="h2 card-title">Coleção Crochê</h2>
...
<section>
    <div>
        <h2 class="h2 section-title">Coleção Nova</h2>
        <a href="#" class="btn-link">
